...
Variables with greater then 80% not available data were removed leaving 60 variables to observe. Removed first 7 variables because they are not related to the exercise.
